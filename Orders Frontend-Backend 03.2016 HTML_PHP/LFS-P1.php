...
<div class="container">
  <div class="content">
    ...
    <table width="962" border="1">
      <tr>
        <td width="197" bgcolor="#66FF99">รหัสสินค้า</td>
        <td width="217" bgcolor="#66FF99">ประเภท</td>
        <td width="303" bgcolor="#66FF99">รายละเอียดสินค้า</td>
        <td width="217" bgcolor="#66FF99">ราคา</td>
      </tr>
      <?php do { ?>
        <tr>
