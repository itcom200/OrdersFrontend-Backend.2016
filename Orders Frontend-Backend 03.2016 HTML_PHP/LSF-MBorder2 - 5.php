...
if (isset($_POST['keyword2'])) {
  $colname_Recordset1 = $_POST['keyword2'];
}
mysql_select_db($database_conpro, $conpro);
$query_Recordset2 = sprintf("SELECT * FROM dbmembers_order WHERE Address LIKE %s ORDER BY mbOrderID ASC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
