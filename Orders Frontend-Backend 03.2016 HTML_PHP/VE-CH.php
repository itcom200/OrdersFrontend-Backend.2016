...
<div class="container">
  <div class="content">
    ...
    <h1>&nbsp;</h1>
    <table width="961" height="382" border="0">
      <tr>
        <td width="471"><img src="Image/technology-environment-01.png" width="471" height="477" /></td>
        <td width="474"><img src="Image/technology-environment-02.png" alt="" width="465" height="473" /></td>
      </tr>
    </table>
  <!-- end .content --></div>
  <p><!-- end .container --></p>
