...
if (isset($_POST['keyword3'])) {
  $colname_Recordset1 = $_POST['keyword3'];
}
mysql_select_db($database_conpro, $conpro);
$query_Recordset2 = sprintf("SELECT * FROM dbmembers_order WHERE Tel LIKE %s ORDER BY mbOrderID ASC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
