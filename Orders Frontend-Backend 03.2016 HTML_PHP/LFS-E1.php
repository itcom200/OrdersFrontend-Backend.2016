...
<table width="1396" height="178" border="0">
  <tr>
    ...
    <td width="1318"><h1> เรียกดูข้อมูลผู้ใช้ระบบ</h1>
    <p>&nbsp;</p></td>
  </tr>
  <tr>
    <td height="96">&nbsp;</td>
    <td><table width="1318" height="94" border="1">
      ...
      <tr>
        ...
        <td><a href="LFS-E11.php?id=<?php echo  $row_Recordset1['id']?>">ลบข้อมูล</a></td>
        <td><a href="LFS-E2.php?id=<?php echo  $row_Recordset1['id']?>">แก้ไข</a></td>
      </tr>
...
<table width="338" height="76" border="0">
  <tr>
    <td width="68">&nbsp;</td>
    <td width="254"><a href="admin-home1.php">&lt;&lt; BACK</a></td>
  </tr>
</table>
</body>
</html>
