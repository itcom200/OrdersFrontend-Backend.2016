...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "LFS-home1.php";
  $MM_redirectLoginFailed = "LFS-home0.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_conpro, $conpro);
  	
  $LoginRS__query=sprintf("SELECT username, password, accesslevel FROM dblfs WHERE username=%s AND password=%s",
...
<div class="container">
  ...
  <div class="footer">
    <table width="950" border="0">
      <tr>
        <td width="22">&nbsp;</td>
        <td width="177"><strong> LOGIN FOR STAFF</strong></td>
        <td width="737"><form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST">
Username :
